            ...
            <div class="row">
                           ...
                           <div class="right">
                               <div class="info">
                                   ...
                                   <div class="info_data">
                                        <div class="data">
                                           ...
                                           <p><?=$_SESSION['emailhod']?></p>
                                        </div>
                                        <div class="data">
                                          <h4><i class="fa-sharp fa-solid fa-id-card-clip"></i>  Full Name</h4>
                                           <p><?=$_SESSION['fnamehod']." ".$_SESSION['lnamehod']?></p>
                                     </div>
                                     <div class="data">
                                       <h4><i class="fa-sharp fa-solid fa-cake-candles"></i>  Birthday</h4>
                                        <p><?=$_SESSION['bdhod']?></p>
                                  </div>
                                   </div>
                               </div>
                             ...
                             <div class="projects">
                                   ...
                                   <div class="data">
                                          <h4><i class="fa-sharp fa-solid fa-chalkboard-user"></i>  university:</h4>
                                           <p> Abdelhamid Mahri Constantine2</p>
                                     </div>
                                     <div class="data">
                                       <h4><i class="fa-sharp fa-solid fa-list-check"></i> Faculty:</h4>
                                        ...
                                        <div class="data">
                                           <h4><i class="fa-sharp fa-solid fa-school"></i>  Departement:</h4>
                                           <p><?=$_SESSION['dephod']?></p>
                                        </div>
                               ...
                               <div class="social_media">
                                   <ul>
                                     <li><a href="index.php" ><i class="fa-sharp fa-solid fa-right-to-bracket"></i> Back</a></li>
                                     <li><a href="update.php" ><i class="fa-sharp fa-solid fa-wrench"></i> Update</a></li>
                                 </ul>
                             </div>
                           </div>
                       </div>
